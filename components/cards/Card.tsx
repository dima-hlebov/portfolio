...
export default function Card({ img, heading, description, icons, mainLink, secondaryLink }:
    { img: StaticImageData, heading: string, description: string, icons?: Icon[], mainLink: string, secondaryLink?: string }) {
    return (
        <div className="max-w-md bg-white border border-gray-200 rounded-2xl shadow hover:scale-105 transition-transform">
            <Link href={mainLink}>
                <Image className="rounded-t-2xl w-full" src={img} alt="Home page" />
            </Link>
            <div>
                <div className="p-5">
                    <Link href={mainLink}>
